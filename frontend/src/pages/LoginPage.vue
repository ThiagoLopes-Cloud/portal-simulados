...
async function handleLogin() {
  ...
  try {
    // Rota corrigida para bater com seu backend/users/urls.py
...
<style scoped>
/* Mantive seus estilos neon idênticos */
...
.input-group input { background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; padding: 14px; color: white; }
