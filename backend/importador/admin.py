...
class ImportacaoProvaAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, change=False, **kwargs):
        ...
        form.base_fields["tipo_exame"].help_text = (
            "Importacao restrita a provas oficiais do ENEM."
        )
    ...
    def save_model(self, request, obj, form, change):
        ...
        try:
            ...
            if obj.total_ocorrencias_com_idioma:
                resumo_ocorrencias += f", incluindo {obj.total_ocorrencias_com_idioma} ocorrencias com idioma"
            resumo_ocorrencias += ")"
...
class QuestaoImportadaAdmin(admin.ModelAdmin):
    ...
    actions = [
        aprovar_e_publicar,
        marcar_correcao_necessaria,
        rejeitar_questoes_importadas,
    ]
