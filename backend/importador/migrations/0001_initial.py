    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(1, "Dia 1"), (2, "Dia 2")], verbose_name="Dia"
                    ),
                ),
                (
                    "cor",
                ...
                (
                    "pdf_prova",
                    models.FileField(
                        upload_to="importacoes/provas/", verbose_name="PDF da prova"
                    ),
                ),
                (
                    "pdf_gabarito",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Total de questões esperado"
                    ),
                ),
                (
                    "status_editorial",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numero_na_prova",
                    models.PositiveIntegerField(verbose_name="Número na prova"),
                ),
                (
                    "texto_bruto",
                    models.TextField(blank=True, verbose_name="Texto bruto extraído"),
                ),
                ...
                (
                    "gabarito_oficial",
                    models.CharField(
                        blank=True, max_length=1, verbose_name="Gabarito oficial"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "motivo_status",
                    models.TextField(blank=True, verbose_name="Motivo do status"),
                ),
                (
                    "criado_em",
                    models.DateTimeField(auto_now_add=True, verbose_name="Criado em"),
